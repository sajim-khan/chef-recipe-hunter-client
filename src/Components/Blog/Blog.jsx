...
const Blog = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      ans: "Node.js and Express.js are two different technologies, but they are often used together in web development Node.js is a runtime environment for executing JavaScript code outside of a web browser. Node.js provides several built-in modules and APIs for handling I/O operations, networking, file system access, and more. Express.js, on the other hand, is a web application framework built on top of Node.js. It provides a set of features and tools that make it easier to build web applications and APIs using Node.js. Express.js includes middleware functions that can be used for tasks such as parsing request data, handling authentication, and serving static files.",
    },
    {
      id: 4,
      question: "What is a custom hook, and why will you create a custom hook?",
      ans: "A custom hook is a reusable function in React that allows you to extract logic and stateful behavior from a component. It enables you to abstract away complex logic and share it across multiple components, enhancing code reusability and maintainability.Creating a custom hook is beneficial in several scenarios. Firstly, it promotes code organization and separation of concerns by isolating specific functionality into its own hook. Secondly, it allows you to create shareable logic that can be easily used in different components, reducing code duplication. Lastly, custom hooks help improve readability and comprehension of components by simplifying their structure and reducing the complexity of the code within them.",
    },
  ];
